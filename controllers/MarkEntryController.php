                ...
                <tr>
                    <td colspan="5">
                      ...
                      <table class="right_table"    width="120%">
                            ...
                            <tr> 
                                <td colspan="4" > &nbsp; </td> 
                                <td  class="stuname" valign="middle" style="padding-bottom:-10px;" height="70px"><b> '.strtoupper($tc['name']).'</b></td>
                            </tr>
                             <tr> 
                                <td colspan="4" > &nbsp; </td> 
                    ...
                    <td colspan="5">
                       <table class="right_table_tc_1"   width="205%">
...
public function actionRevaluationSubjectEntry()
    ...
    public function actionNoticeboardCopyPdf()
    {
        ...
        $pdf = new Pdf([
            ...
            'cssFile' => '@vendor/kartik-v/yii2-mpdf/assets/kv-mpdf-bootstrap.min.css',
            'cssInline' => ' @media all{
                        table{border: none; font-family:"Roboto, sans-serif"; width:100%; font-size:11px; }
                    }   
                ',
            'options' => ['title' => 'Noticeboard Data'],
            'methods' => [
                'SetHeader' => ["OFFICE OF THE CONTROLLER OF EXAMINATIONS ".$org_name],
                'SetFooter' => ['Noticeboard Data' . ' :  PAGE :{PAGENO}'],
            ]
        ]);
        Yii::$app->response->format = \yii\web\Response::FORMAT_RAW;
        $headers = Yii::$app->response->headers;
            ...
            if (count($students_map_id_pass) > 0) 
            {
                ...
                $data .= '<tr>
                            <td colspan=8 align="center"> 
                                ...
                                <center>Consolidated Results '.$MON_name->description."-".$_POST['year'].' Examinations</center>
  ...
  //print_r($deg_info);exit;
        ...
        //$ug_maximum_marks = 4000;
           ...
           // $pg_maximum_credits = 234;
            ...
            if($batch==7 && $deg_info['degree_type']=='UG')
            {
                $ug_maximum_credits = 140;
                $ug_maximum_marks = 3500;
            }
         
            elseif($batch==9 && $deg_info['degree_type']=='UG' && $get_batc_map['coe_programme_id']!==19 )
            {
                $ug_maximum_credits = 140;
                $ug_maximum_marks = 3500;
            }
            ...
            elseif($batch==10 && $deg_info['degree_type']=='UG')
            {
                $ug_maximum_credits = 140;
                $ug_maximum_marks = 4000;
            }
            elseif($batch==14  && $deg_info['degree_type']=='UG')
            {
                $ug_maximum_credits = 140;
                $ug_maximum_marks = 4000;
            }
            elseif($deg_info['degree_type']=='PG' && $get_batc_map['coe_programme_id']!==4 && $get_batc_map['coe_programme_id']!==32 )
            {
                $pg_maximum_credits = 90;
                $pg_maximum_marks = 2250;
            }
            elseif($deg_info['degree_type']=='PG' && $get_batc_map['coe_programme_id']!==4 && $get_batc_map['coe_programme_id']==32)
            {
                $pg_maximum_credits = 91;
                $pg_maximum_marks = 2250;
            }
            elseif($deg_info['degree_type']=='PG' && $get_batc_map['coe_programme_id']==4)
            {
...
$semester_array = ['1'=>'I','2'=>'II','3'=>'III','4'=>'IV','5'=>'V','6'=>'VI','7'=>'VII','8'=>'VIII','9'=>'IX','10'=>'X','11'=>'XI','12'=>'XII','13'=>'XIII','14'=>'XIV'];
   ...
   public function actionSubAdditionalPdf()
    ...
    public function actionAdd()
    {
        ...
        if (isset($_POST['internetcopybutton'])) 
        {
            ...
            $internet_copy_query->select('c.register_number,subject_code,subject_name,ese_maximum,ese_minimum,cia_maximum,cia_minimum,a.CIA,a.ESE,a.result,a.total,a.grade_name,a.grade_point,a.student_map_id,a.exam_year as year,a.out_of_maximum as secured,a.exam_month as month,degree_code,programme_name,k.batch_name,a.grade_point')
                ->from('coe_additional_credits a')
                ->join('JOIN', 'coe_student_mapping b', 'a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN', 'coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN', 'coe_bat_deg_reg g','g.coe_bat_deg_reg_id=b.course_batch_mapping_id')
        ...
        // print_r($internet_copy_query);exit;            
            ...
            array_multisort(array_column($internet_copy, 'register_number'),  SORT_ASC, $internet_copy);
             ...
             $internet_copy_query_2 = new Query();
             $internet_copy_query_2->select('c.register_number,subject_code,subject_name,ese_max,ese_min,cia_max,cia_min,a.CIA,a.ESE,a.result,a.total,a.grade_name,a.grade_point,a.subject_map_id,a.student_map_id,a.year,a.month,degree_code,programme_name ,a.ESE as secured,k.batch_name,a.grade_point')
                ->from('coe_value_mark_entry a')
                ->join('JOIN','coe_student_mapping b','a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN','coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN','sub d','a.subject_map_id=d.coe_sub_mapping_id')
 ...
 public function actionAdcNptlCoursera()
   ...
   public function actionAdcNptlCourseraPdf()
    ...
    public function actionValuatorAdcMarkentry()
    {
        ...
        { 
            ...
            $val_fac_allcoate = Yii::$app->db->createCommand("SELECT total_answer_scripts,val_faculty_all_id,subject_pack_i,B.subject_mapping_id FROM coe_valuation_adc_faculty_allocate as A join coe_add_answerpack_regno as B on B.answer_packet_number=A.subject_pack_i  WHERE  B.exam_month='" . $month . "' AND B.exam_year='" . $year . "' AND A.val_faculty_all_id='" . $val_faculty_all_id . "'")->queryAll();
            
            foreach($val_fac_allcoate as $value)
            {
             

             $check_verify_details = Yii::$app->db->createCommand("SELECT count(dummy_number) FROM coe_valuator_adc_markentry WHERE val_faculty_all_id='" . $value['val_faculty_all_id'] . "' and   answer_packet_number='" . $value['subject_pack_i'] . "'")->queryScalar();
            // echo "SELECT count(dummy_number) FROM coe_valuator_adc_markentry WHERE val_faculty_all_id='" . $value['val_faculty_all_id'] . "' and   answer_packet_number='" . $value['subject_pack_i'] . "'";exit;
            ...
            if($value['total_answer_scripts']==($check_verify_details))
            {
                 Yii::$app->ShowFlashMessages->setMsg('Error','Packet Already done! Please Check');
                  return $this->redirect(['dummy-numbers/valuator-adc-markentry']); 
            }
            else
            {
                $success=0;
                ...
                {  
                    //echo "SELECT * FROM coe_valuator_markentry WHERE dummy_number='".$dummynumbers[$i]."'"; 
                      $dummymark = Yii::$app->request->post('actxt_' .  $i . '');
                       // print_r($dummymark);exit;
                        $out_of_maximum=Yii::$app->request->post('actxttotal_' .  $i . '');
                    
                     $check_verify_details = Yii::$app->db->createCommand("SELECT count(dummy_number) FROM coe_valuator_adc_markentry WHERE dummy_number='".$dummynumbers[$i]."'")->queryScalar();  
                        ...
                        $insert = Yii::$app->db->createCommand('INSERT into coe_valuator_adc_markentry(val_faculty_all_id, dummy_number,answer_packet_number,marks,out_of_maximum, created_at, created_by,year,month) values("'.$val_faculty_all_id.'","'.$dummynumbers[$i].'","'.$value['subject_pack_i'].'","'.$dummymark.'","'.$out_of_maximum.'","'.date('Y-m-d H:i:s').'","'.$user_id.'","'.$year.'","'.$month.'") ')->execute();
                ...
                if($success>0)
                {
                    ...
                    $check_verify = Yii::$app->db->createCommand("SELECT * FROM coe_valuator_adc_markentry WHERE val_faculty_all_id='" . $val_faculty_all_id . "' ORDER BY dummy_number")->queryAll(); 
                    //print_r($check_verify); exit;
                    return $this->render('valuator-adc-markentry', [
                        'model' => $model,
                ...
                else
                {
                    ...
                    return $this->redirect(['mark-entry/valuator-adc-markentry']);
                }
  ...
  public function actionVerifydetailsPdf3()
    {
        ...
        $pdf = new Pdf([
            ...
            'options' => ['title' => 'Evaluator Marks Entry Details'],
            'methods' => [
                //'SetHeader' => ["OFFICE OF THE CONTROLLER OF EXAMINATIONS "],
                //'SetFooter' => ['Evaluator Mark Entry Details' . ' PRINTED ON : '.$sdate.'  PAGE :{PAGENO}'],
            ]
        ]);
        Yii::$app->response->format = \yii\web\Response::FORMAT_RAW;
        $headers = Yii::$app->response->headers;
  ...
  public function actionValuatorAdcMarkentryReport()
    {
        $model = new DummyNumbers();
        $factallModel = new ValuationFacultyAllocate();
        
        Yii::$app->ShowFlashMessages->setMsg('Welcome','Welcome to Valuator Mark Entry Report');
        return $this->render('valuator-adc-markentryreport', [
                        'model' => $model,
                        'factallModel' =>$factallModel,
                        'verify_stu_data'=>'',
                        'val_faculty_all_id'=>'',
 ...
 public function actionValuatorAdcMarkentryUpdate()
    {
        $model = new DummyNumbers();
        $factallModel = new ValuationFacultyAllocate();
        
        Yii::$app->ShowFlashMessages->setMsg('Welcome','Welcome to Valuator Mark Entry Update');
        return $this->render('valuator-adc-markentry-update', [
                        'model' => $model,
                        'factallModel' =>$factallModel,
                        'verify_stu_data'=>'',
                        'val_faculty_all_id'=>'',
   ...
   public function actionMarkStatementAdc()
    {
        $model = new MarkEntry();
        $student = new Student();
        $det_cat_type = Yii::$app->db->createCommand("select coe_category_type_id from coe_category_type where category_type like '%detain%'")->queryScalar();
      ...
      //  ->andWhere(['NOT IN', "F.student_map_id", $withheld])
            ...
            if (!empty($mark_statement)) {
                if ($file_content_available == "Yes") {
                    return $this->render('mark-statement-adc', [
                       'model' => $model,
                       'top_margin'=>$top_margin,
                       'bottom_margin'=>$bottom_margin,
                       'student' => $student,
                    ...
                    Yii::$app->ShowFlashMessages->setMsg('Error', "No Institute Information Found");
                    return $this->redirect(['mark-entry/mark-statement-adc']);
                }
            } else {
                Yii::$app->ShowFlashMessages->setMsg('Error', "No data Found ");
                return $this->redirect(['mark-entry/mark-statement-adc']);
    ...
    // Mark Statement Pdf
  public function actionMarkStatementArtsPrintAdcPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        $content = $_SESSION['mark_statement_adc_pdf'];
        $pdf = new Pdf([
            'mode' => Pdf::MODE_CORE,
            'filename' => ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT) . ' MARK STATEMENT.pdf',
            'format' => Pdf::FORMAT_A4,
            'orientation' => Pdf::ORIENT_PORTRAIT,
            'content' => $content,         
            'cssFile' => 'css/arts_college_mark_statement_adc.css',
            'options' => ['title' => strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT)) . ' MARK STATEMENT'],
        ]);
    ...
    public function actionSubjectinformationadc()
    {
        $model = new MarkEntry();
        $markentrymaster = new MarkEntryMaster();
        $galley = new HallAllocate();
        Yii::$app->ShowFlashMessages->setMsg('Welcome', 'Welcome to ' . ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT) . ' Information');
        return $this->render('subjectinformationadc', [
            'model' => $model, 'galley' => $galley,
        ]);
    }
    public function actionSubjectinformationadcdata()
    {
        $year = Yii::$app->request->post('year');
        //print_r($year);exit;
        $month = Yii::$app->request->post('month');
        ...
        $sn = 1;
       /* $query = new Query();
        $query->select(['A.subject_code','A.subject_name','A.part_no','A.exam_year','A.exam_month','A.cia_maximum as CIA_max', 'A.cia_maximum as CIA_min','A.ese_minimum as ESE_min','A.ese_maximum as ESE_max','A.credits','A.total_minimum_pass','A.course_type_id'])
            ->from('coe_additional_credits A')
            ->join('JOIN', 'coe_category_type G', 'G.coe_category_type_id=A.course_type_id')
           ->where(['A.exam_year'=>$year,'A.exam_month'=>$month])->groupBy('A.subject_code')->orderBy('semester');
           $additionalsubinfo = $query->createCommand()->queryAll();*/

          $query = new Query();
          $query->select('F.batch_name,C.degree_code,B.programme_name,B.programme_code,AN.subject_code,AN.subject_name,AN.part_no,AN.exam_year,AN.exam_month,AN.cia_maximum as CIA_max, AN.cia_maximum as CIA_min,AN.ese_minimum as ESE_min,AN.ese_maximum as ESE_max,AN.credits,AN.total_minimum_pass')
            ->from('coe_bat_deg_reg A')
            ->join('JOIN', 'coe_programme B', 'A.coe_programme_id=B.coe_programme_id')
            ->join('JOIN', 'coe_degree C', 'A.coe_degree_id=C.coe_degree_id')
            //->join('JOIN', 'coe_category_type I', 'I.coe_category_type_id=AN.course_type_id')
            ->join('JOIN', 'coe_batch F', 'A.coe_batch_id=F.coe_batch_id')
            ->join('JOIN', 'coe_additional_credits AN')
            ->where(['AN.exam_year'=>$year,'AN.exam_month'=>$month])->groupBy('AN.subject_code')->orderBy('semester');
        $additionalsubinfo = $query->createCommand()->queryAll();

        //print_r($additionalsubinfo);exit;
        ...
        $query->select('F.batch_name,C.degree_code,B.programme_name,B.programme_code,E.semester,D.subject_code,D.subject_name,D.CIA_max,D.ESE_max,D.total_minimum_pass,D.credit_points,D.CIA_min,D.ESE_min,G.description as paper_type,H.description as subject_type,I.description as course_type,paper_no,part_no')
            ...
            ->where(['MN.year'=>$year,'MN.month'=>$month,'E.course_type_id'=>122])->groupBy('D.subject_code')->orderBy('semester');
        $subject_adc_info = $query->createCommand()->queryAll();

        if(!empty($subject_adc_info))
        {
            $subject_adc = array_merge($additionalsubinfo,$subject_adc_info);
           
        }
       
        if (count($subject_adc) > 0) {
            ...
            foreach ($subject_adc_info as $subject1) {
                $table .= '
                    <tr>
                        <td> ' . $sn . ' </td>
                        <td> ' . $year . ' </td>
    ...
    public function actionSubjectinformationadcPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        $content = $_SESSION['subject_information_print'];
        //unset($_SESSION['student_application_date']);
    ...
    public function actionExcelSubjectinformationadc()
    {
