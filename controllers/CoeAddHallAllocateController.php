...
class CoeAddHallAllocateController extends Controller
{
 ...
 public function actionGalleyReport()
    ...
    public function actionValuationfacultyallocateadc()
    {
        ...
        return $this->render('valuation_faculty_allocate_adc', [
            'model' => $model,
            'examTimetable' => $examTimetable,
  ...
  public function actionValuationfacultyallocateadcPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));   
  ...
  public function actionValuationfacultyallocateadcExcel()
   {
        $content = $_SESSION['get_print_valfaculty'];
